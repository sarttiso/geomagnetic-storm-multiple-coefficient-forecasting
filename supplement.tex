...
\begin{figure}[htbp]
   ...
   \caption{\replaced{Pearson correlation coefficients and root mean squared errors }{Statistics }of persistence forecasting of Est \added{and Dst }with lags up to \replaced{6}{24} hours, demonstrating how persistence forecasting \deleted{even a day in advance} results in deceptively correlative and \replaced{precise}{accurate} forecasts. \added{On the left, forecasting is shown for all Est and Dst observations from 1996-2018, while on the right, storm-time observations have been isolated for persistence forecasting.}}
