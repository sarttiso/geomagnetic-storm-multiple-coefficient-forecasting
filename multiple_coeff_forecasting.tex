...
\title{Probabilistic forecasting of geomagnetic disturbances with deep learning: from univariate Dst-based prediction to probabilistic multivariate inference with realistic Earth}
...
\authors{Adrian Tasistro-Hart\affil{1}, Alexander Grayver\affil{1}, Alexey Kuvshinov\affil{1}}
...
\correspondingauthor{Adrian Tasistro-Hart}{adrianta@ethz.ch}
